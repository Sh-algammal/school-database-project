...
🔗 StudentCourses_3nf (Junction Table)

This ensures strict data integrity, minimized redundancy, and highly efficient data management.

🚀 How to Run

Open your preferred SQL environment (e.g., MySQL, SQL Server, PostgreSQL).

Create the tables in the following order to respect Foreign Key constraints:
...
Execute the INSERT INTO statements provided in the 3NF section to populate the tables with sample data.

Run standard SELECT queries with JOIN statements to test the relationships.
